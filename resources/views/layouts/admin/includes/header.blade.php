    ...
    <div class="d-flex">
        ...
        <form class="app-search d-none d-lg-block">
            <div class="position-relative">
                <input type="text" class="form-control" placeholder="Pesquisar cliente com CPF, ID ou benefício">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                ...
                <div class="p-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="m-0" key="t-notifications"> ACEITE CONFIRMADO / PÊNDENCIADO </h6><span class="badge rounded-pill bg-info float-end"
                            key="t-new">3 total</span>
                        </div>
                    </div>
                </div>
                <div data-simplebar style="max-height: 230px;">
