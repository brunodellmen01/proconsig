...
if (!empty(\Illuminate\Support\Facades\Auth::user()->thumb) && \Illuminate\Support\Facades\File::exists(public_path() . '/storage/' . \Illuminate\Support\Facades\Auth::user()->thumb)) {
    $cover = '/storage/' . \Illuminate\Support\Facades\Auth::user()->thumb;
} else {
    $cover = url(asset('backend/images/no_avatar.jpg'));
}
@endphp
    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dash') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('backend/images/favicon.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/images/favicon.png') }}" alt="" height="17">
                    </span>
                </a>

                <a href="{{ route('admin.dash') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('backend/images/favicon.png') }}" alt="" height="40">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ $cover }}" alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{ Auth::user()->name }}</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ url('admin/profile', ['id' => Auth::user()->id]) }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span
